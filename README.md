...
- 🔹 JavaScript – podstawowe użycie w widokach (dynamiczne elementy)  
...
- 🔹 PostgreSQL *(learning)*  
- 🔹 React / TypeScript *(learning – projekt w toku)*  
- 🔹 Docker – lokalne środowiska dla narzędzi AI  
...
- 🔹 Docker – local environments for AI tools  
...
- 📦 Docker Compose + full-stack deployment flows  
